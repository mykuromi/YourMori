...
<head>
<meta charset="UTF-8">
<title>notice/noticreply.jsp</title>
...
<article>
<h1>Reply</h1>
<form action="${pageContext.request.contextPath}/NoticeReplyAction.bo?pageNum=<%=pageNum%>" method="post" enctype="multipart/form-data">
	...
	<table id="notice">
		<tr>
			<td>Writer</td>
			<td><input type="text" name="name" value="${id }" size="70" readonly> </td>
		</tr>
		<!-- 비밀번호 -->
		
		<tr>
			<td>Subject</td>
			<td><input type="text" name="subject" size="70" value="[답글]"></td>
		</tr>
		<tr>
			<td>File Upload</td>
		...
		<tr>
			<td>Content</td>
			<td><textarea rows="10" cols="18" name="content" style="width:85%; height:100%;"></textarea></td>
		</tr>	
	</table>
	<div id="table_search">
